# Well cover dataset 10400 images in YOLO format including 5 categories: g

# Body

Well cover dataset, 10400 images in YOLO format, containing 5 categories: good (in good condition), broken (broken), lost (lost), uncovered (uncovered/raised), circle (broken well cover). The images are clear and labeled comprehensively. Suitable for target detection projects such as well cover inspection, road check, urban maintenance, etc. It is ready to use directly, saving time and effort


Category ID Category Image Count Annotation Count
0 Good (In good condition) 2,701 4,616
1 Broken (Damaged) 1,922 3,369
2 Lost (Lost) 2,219 3,630
3 Uncovered (Uncovered/Curls Up) 2,546 3,883
4 Circle (Well collar damaged) 1,640 3,077
